...
public class main{
    ...
    for (int index = 0; index < barang.size(); index++) {
        ...
        System.out.println("Nama Kargo Penirim  : " + barang.get(index).kargo_pengirim);
        System.out.println("Nama barang         : " + barang.get(index).nama_barang);
        System.out.println("Jumlah barang       : " + barang.get(index).jumlah_barang);
        System.out.println("Kategori barang     : " + barang.get(index).kategori);
        System.out.println("Satuan barang       : " + barang.get(index).satuan_barang);
        System.out.print("\n");
        }
        int index = 0;
            index++;
    ...
    public static void updatedata() throws IOException{
        ...
        int index = 0;
            index++;
        // perulangan if di gunakan untuk mengecek apakah terdapat terdapat data di array berdasarkan index nya
        if(index > 0 && index <= barang.size()) {
    ...
    public static void deletedata() throws IOException{  
        ...
        if(index > 0 && index <= barang.size()) {
            System.out.print("Masukan Data Barang ke-");
            Integer.parseInt(br.readLine());
